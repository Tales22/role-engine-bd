...
--
-- Host: localhost    Database: role_engine_db
-- ------------------------------------------------------
...
CREATE TABLE `atributos` (
  ...
  CONSTRAINT `atributos_ibfk_1` FOREIGN KEY (`personaje_id`) REFERENCES `personajes` (`id`) ON DELETE CASCADE
...
CREATE TABLE `personajes` (
  ...
  CONSTRAINT `personajes_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-02-23 15:28:48
